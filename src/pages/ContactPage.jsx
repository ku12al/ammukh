            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  For urgent matters or investment inquiries, we typically respond within 24 hours during business days.
                  For general inquiries, please allow up to 48 hours for a response.
                </p>
              </div>
            </div>
          </div>
