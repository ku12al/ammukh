              ...
              <form className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="under-50k">Under ₹50 Lakhs</SelectItem>
                          <SelectItem value="50k-1cr">₹50 Lakhs - ₹1 Crore</SelectItem>
                    ...
                    <div>
                      ...
                      <Input placeholder="₹0 if pre-revenue" />
                    </div>
                  </div>
                  <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input placeholder="Google Drive, Dropbox, or other shareable link" />
                ...
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 text-lg font-medium">
                    Submit Application
                  </Button>
                </div>
              </form>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">
                  Our typical investment ranges from ₹50 lakhs to ₹5 crores, depending on the stage, funding
                  requirements, and growth potential of the company.
                </p>
              </CardContent>
            </Card>
            <Card>
